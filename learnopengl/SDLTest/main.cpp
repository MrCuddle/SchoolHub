...
bool init()
{
    ...
    else
    {
        ...
        //Create window
        gWindow = SDL_CreateWindow( "SimmeGL", SDL_WINDOWPOS_UNDEFINED, SDL_WINDOWPOS_UNDEFINED, SCREEN_WIDTH, SCREEN_HEIGHT, SDL_WINDOW_OPENGL | SDL_WINDOW_SHOWN );
        if( gWindow == NULL )
        {
...
void renderSecondPass()
{
    ...
    glm::vec3 blue( 0, 0, 1 );
    debugGeom.setupViewProjection( view, projection );
    debugGeom.renderLine( glm::vec3( -1, 1, 1 ), glm::vec3( -1, 1, -1 ), blue );
    glm::mat4 boxModel = glm::mat4();
    boxModel = glm::translate(boxModel, glm::vec3(0,0,-2));
    debugGeom.renderBox(boxModel);
